...
class Pac(pygame.sprite.Sprite):
	...
	# Obtiener todas las imágenes necesarias para animar la acción específica del pacman.
	...
	# actualización con sprites/hojas
	def animate(self, pressed_key, walls_collide_list):
		animation = self.animations[self.status]

		# bucle sobre índice de fotograma
	...
	def update(self):
		# Temporizador basado en el recuento de FPS
