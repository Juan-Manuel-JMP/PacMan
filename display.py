...
class Display:
	...
	def game_over(self):
		message = self.game_over_font.render(f'Juego Perdido =(', True, pygame.Color("Green"))
		instruction = self.font.render(f'Presina "R" para Reiniciar', True, pygame.Color("violet"))
